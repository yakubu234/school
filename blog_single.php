		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 col-sm-6">
				<ul class="breadcrumb">
					...
					<li><a href="blog.php">educo blog</a></li>
					<li><i class="fa fa-chevron-left"></i></li>
					<li><a href="blog_single.php">single post</a></li>
				</ul>
			</div>
		</div>
	</div>
				...
				<div class="ed_blog_all_item">
					<div class="ed_blog_item ed_bottompadder50">
						<div class="ed_blog_image">
							<img src="http://placehold.it/846X360" alt="blog image" />
						</div>
					<div class="ed_blog_info">
						...
						<p>Quisque ornare, massa sed dictum porta, mi tortor sagittis neque, non molestie libero est vestibulum nisl. Nulla varius mi ligula. Vestibulum molestie pulvinar risus nec egestas. Praesent fringilla erat quam, sit amet ultricies felis lacinia quis. Integer ac lacus nunc. Mauris quam massa, finibus et ex sit amet, lacinia molestie lorem. Etiam sed ante eget nibh varius mattis nec sit amet ante. Morbi euismod felis at massa pulvinar rutrum. Curabitur posuere tortor non velit semper tincidunt non ut lacus. Duis pretium laoreet urna. Duis vulputate, velit id placerat pharetra, tortor dui ultricies turpis, nec ullamcorper erat felis eu erat. Nulla facilisi. Etiam augue lectus, luctus ac eros a, faucibus iaculis quam. Nam non iaculis justo. Donec maximus varius velit. In hac habitasse platea dictumst.</p>
					</div>
