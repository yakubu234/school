...
if (isset($_POST['submit'])) {
	...
	$name = $_POST['name'];
	$sch = $_POST['sch'];
	 $ins = "INSERT INTO activity (teacher_id,teacher_name,info,descp,send_on) VALUES ('$record','$name','$que','$sch',NOW())";
	  $res = $conn-> query($ins);
         if($res === TRUE)
    {
        echo "<script>
					...
					<div class="ed_inner_dashboard_info">
						...
						<div class="row">
							<div class="container col-sm-12">
								<h4>Write through this textarea </h4>
								<div class="panel panel-default col-sm-9">
									<div class="panel-body">
										<form class="md-form" method="POST" action="#" enctype="multipart/form-data" >
											<div class="form-group">
												<label for="exampleFormControlTextarea1">write here 
													...
													<input type="text" style="display: none;" name="sch" value="<?php echo $sch; ?>" >
													<input type="text" style="display: none;" name="record" value="<?php echo $record ?>" >
												<!--div class="container">
													<div class="box">
														<input type="file" name="file-2[]" id="file-2" class="inputfile inputfile-2" data-multiple-caption="{count} files selected" multiple accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf"  />
														<label for="file-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Choose a file&hellip;</span></label>
													</div>
												</div-->

												<input name="submit" type="submit"  class="btn ed_btn ed_orange pull-right" value="submit" >
