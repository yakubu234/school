...
>>>>>>> 42db2460d906b0a76aaea5085437c570e951f23f
							...
							<!-- LAYER NR. 1 -->
								<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
									...
									style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;     font-family: 'Roboto Slab', serif;">We help students reach their life goals
								</div>
								<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
					...
					<div class="owl-carousel owl-theme">
						<div class="item">
							<div class="ed_item_description">
								...
								<p>Not only high schools, we can offer help for elementary schools as well. Make sure your kid becomes a superstar.</p>
								<a href="signup.php" class="ed_getinvolved">get involved <i class="fa fa-long-arrow-right"></i></a>
							</div>
						</div>
						<div class="item">
							<div class="ed_item_description">
						...
						<div class="item">
							<div class="ed_item_description">
								...
								<p>There is significant research that supports the impact of individual attention on both academic performance.</p>
								<a href="signup.php" class="ed_getinvolved">get involved <i class="fa fa-long-arrow-right"></i></a>
							</div>
						</div>
						<div class="item">
							<div class="ed_item_description">
								...
								<p>As mentioned above, for many students, their own peers can have every bit the credibility that a teacher does.</p>
								<a href="signup.php" class="ed_getinvolved">get involved <i class="fa fa-long-arrow-right"></i></a>
							</div>
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="ed_video_section_discription">
					<h4>Learn how to use Highschool</h4>
					<p>Highschool is a platform that enables teachers to share content,manage communications, and distribute assignments with students, colleagues, and parents</p>
					<span><a href="#" class="btn ed_btn ed_orange">Learn More</a></span>
				</div>
			</div>
		</div>
	</div>
				...
				<div id="owl-demo2" class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="ed_item_description">
							...
							<p>We are glad to inform you that our Platform is going through user testing. Signup,Test, and give Feedback. </p>
							<a href="">read more <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
					<div class="item">
						<div class="ed_item_description">
							<h4>Updated security</h4>
							<p> Because your data is confidential to you, we are working tirelessly to protect them</p>
							<a href="">read more <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
					<div class="item">
						<div class="ed_item_description">
							<h4>Compatibility with mobile device </h4>
							<p>We ensure our platform is well tailore for mobile compatibility</p>
							<a href="">read more <i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div> 
				</div>
